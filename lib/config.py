...
def load() -> CentinelConfig:
    ...
    # CENTINEL_WIKI_PATH overrides the YAML. Single source of truth — the
    # whole stack now runs on the host (web app + dispatcher + Hermes), so
    # there's no longer a container/host path split.
