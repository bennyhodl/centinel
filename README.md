...
Centinel is a self-hosted civic transparency platform built on three principles drawn directly from Bryan's playbook:

- **Documents over promises.** Every claim made by any agent in this system cites a vault path — a hashed, immutable copy of the source PDF, transcript, or capture. *No citation, no claim.* The watchman demands the original record, not the official summary.
